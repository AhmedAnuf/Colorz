...
<div class="row">
<div class="col-sm-8"><h2>Agent <b>Information</b></h2></div>
<div class="col-sm-4">
<a href="Agent_Form.php">
    ...
    <?php
            ...
            while($row = mysqli_fetch_array($run)) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="adelete.php?del=<?php echo $salesagentid ?>"><button class="Delbtn">Delete</button></a>
                    </td>

...
<div class="row">
<div class="col-sm-8"><h2>Sales <b>Information</b></h2></div>
<div class="col-sm-4">
<a href="Sales_Form.php">
...
<table class="table">
    ...
    <?php
            ...
            while($row = mysqli_fetch_array($run)) {
                ...
                $quotid = $row["Quote_ID"];
                $warehouse = $row["Warehouse_Details"];
                ...
                <tr>
                    <td><?php echo $uid ?></td>
                    <td><?php echo $salesagentname ?></td>
                    <td><?php echo $salesagentid ?></td>
                    <td><?php echo $saleslead ?></td>
                    <td><?php echo $quotid ?></td>
                    <td><?php echo $warehouse ?></td>
                    <td><?php echo $supplier ?></td>

                    <td>
                        <a href="sdelete.php?del=<?php echo $salesagentid ?>"><button class="Delbtn">Delete</button></a>
                    </td>
